...
export default function Game() {
  ...
  const winOrNot = (game) => {
    ...
    if (
      (game.n9 === game.n8 && game.n9 !== "" && game.n9 === game.n7) ||
      (game.n4 === game.n5 && game.n4 !== "" && game.n4 === game.n6) ||
      (game.n1 === game.n2 && game.n1 !== "" && game.n1 === game.n3)
    ) {
      console.log("Ligne Horizontale _");
      setGameInProgress((prevState) => ({
        ...prevState,
        gameStatus: -1,
        winner: "Le gagnant est " + gameInProgress.prevPlayer,
      }));
    }
    // Condition de win pour ligne verticale
    else if (
      (game.n9 === game.n6 && game.n9 !== "" && game.n9 === game.n3) ||
      (game.n8 === game.n5 && game.n8 !== "" && game.n8 === game.n2) ||
      (game.n7 === game.n4 && game.n7 !== "" && game.n7 === game.n1)
    ) {
    ...
    // Condition de win pour ligne diagonale
      ...
      (game.n9 === game.n5 && game.n9 !== "" && game.n9 === game.n1) ||
      (game.n7 === game.n5 && game.n7 !== "" && game.n7 === game.n3)
    ) {
    ...
    console.log(gameInProgress.gameStatus);
    console.log("fin de fonction winOrNot");
  };
  ...
  const changePlayer = () => {
    ...
    console.log("fin de fonction de changePlayer");
  };

  // Retournes le board en HTML tout en propageant les propss
